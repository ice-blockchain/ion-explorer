                    ...
                    <div class="card-row">
                        ...
                        <div class="card-row__value card-row__value--flex-row">
                            <div class="card-row">
                                ...
                                <div class="card-row__value">
                                    <span v-if="totalStake === undefined" class="skeleton">10000 ICE</span>
                                    <template v-else>
                                        {{$ton(totalStake)}} ICE
                                    </template>
                                </div>
                            ...
                            <div class="card-row">
                                ...
                                <div class="card-row__value">
                                    <span v-if="poolInfo.validator_amount === undefined" class="skeleton">10000 ICE</span>
                                    <template v-else>
                                        {{$ton(poolInfo.validator_amount)}} ICE
                                    </template>
                                </div>
                            </div>
                            <div class="card-row">
                                ...
                                <div class="card-row__value">
                                    <span v-if="totalNominatorStake === undefined" class="skeleton">10000 ICE</span>
                                    <template v-else>
                                        {{$ton(totalNominatorStake)}} ICE
                                    </template>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-row__value card-row__value--flex-row">
                            <div class="card-row">
                                ...
                                <div class="card-row__value">
                                    ...
                                    <template v-else>{{$ton(poolInfo.min_validator_stake)}} ICE</template>
                                </div>
                            </div>
                            <div class="card-row">
                                ...
                                <div class="card-row__value">
                                    ...
                                    <template v-else>{{$ton(poolInfo.min_nominator_stake)}} ICE</template>
                                </div>
                            </div>
                        </div>
                    </div>
